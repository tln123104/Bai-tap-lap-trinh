/* Bài 6.11: Viết chương trình nhập một số nguyên n và một dãy n số nguyên dương a1, a2,..., an (n ≤ 105 , ai ≤ 10°).
Đặt: dist(a) = max(a) - min(a), trong đó: max(a) là giá trị lớn nhất của dãy số a, min(a) là giá trị nhỏ nhất của dãy số a.
